#in groupchat, don't need to specify order
#broadcast messages to all agents
#different from sequential -- specify order, only specific agents receive messages
import json
import string
import uuid
...
logging_session_id = autogen.runtime_logging.start(config={"dbname": "groupchat_logs.db"})
